...
public class LuceneQueryApp {
	...
	private void loop() throws IOException, ParseException {
		...
		while(queryText != null) {
			...
			TopDocs results = findTopDocs(query, 1);
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		LuceneQueryApp queryApp = new LuceneQueryApp(Paths.get("D:\\eddress\\lucene\\lucene-testbed\\src\\main\\java\\ca\\dougsparling\\luceneblogpost\\storage\\index"));
		queryApp.loop();
	}
}
